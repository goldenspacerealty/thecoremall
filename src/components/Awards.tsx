...
const brands = [
  ...
  { image: "/Brand/mcdonalds.png", name: "McDonalds" },
  { image: "/Brand/blackberry.png", name: "Blackberry" },
  { image: "/Brand/foodforuma.jpg", name: "Food Foruma" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-1">
              <p className="text-xs uppercase tracking-[0.3em] text-accent-purple font-semibold">
                The Destination
              </p>
            ...
            <p className="text-muted-foreground leading-relaxed text-base">
              The Core Mall Ghaziabad represents the perfect synergy of luxury
              retail and modern living. Strategically located where the crowd is
              today, it offers a high-yield investment opportunity in the heart
              of a flourishing market.
            </p>

            <div className="border-l-4 border-accent-purple pl-5 space-y-3">
              <p className="text-lg font-black text-foreground">
                Why Choose The Core Mall?
              </p>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  ...
                  Located in Ghaziabad's most active hub.
                </li>
                <li>
                  <span className="font-semibold text-foreground">
                    Retail Excellence:
                  </span>{" "}
                  Home to 21+ premium international brands.
                </li>
                <li>
                  <span className="font-semibold text-foreground">
                    Dual Investment:
                  </span>{" "}
                  Luxury retail shops and stylish studio apartments.
                </li>
                <li>
                  <span className="font-semibold text-foreground">
                    Instant Footfall:
                  </span>{" "}
                  Positioned where the people are, ensuring immediate returns.
                </li>
                <li>
                  <span className="font-semibold text-foreground">
                    Modern Lifestyle:
                  </span>{" "}
                  Exceptional amenities paired with world-class architecture.
                </li>
              </ul>
            </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 space-y-3">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm">
                Investing in{" "}
                <span className="font-bold text-foreground">"The Core"</span>{" "}
                isn't just about buying property; it's about securing a stake in
                a thriving economy. Whether you are looking for a
                high-visibility shop or a premium studio apartment, this is
                where luxury meets profitability.
              </p>
