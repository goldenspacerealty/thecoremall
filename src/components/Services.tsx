...
export function Services() {
  ...
  const services = [
    {
      id: "retail",
      title: "Premium Retail Shops",
      description: "High-visibility retail spaces with premium footfall.",
      color: "accent-emerald",
      rotation: "rotate-2",
      image: "/gleary/gl6.avif",
    },
    {
      id: "studio",
      title: "Studio Apartments",
      description: "Modern studio apartments with luxury amenities.",
      color: "accent-blue",
      rotation: "-rotate-1",
      image: "/gleary/gl3.avif",
    },
    {
      id: "food",
      title: "Food & Beverage Zone",
      description: "Premium F&B outlets with top international brands.",
      color: "accent-purple",
      rotation: "rotate-1",
      image: "/gleary/gl4.avif",
    },
    {
      id: "entertainment",
      title: "Entertainment Hub",
      description: "Cinema, gaming & entertainment for all age groups.",
      color: "accent-emerald",
      rotation: "-rotate-2",
      image: "/gleary/gl5.avif",
    },
    {
      id: "investment",
      title: "Investment Opportunity",
      description: "High-yield returns in Ghaziabad's prime location.",
      color: "accent-blue",
      rotation: "rotate-3",
      image: "/gleary/gl6.avif",
    },
    {
      ...
      description: "Strategically located where the crowd is today.",
      color: "accent-purple",
      rotation: "-rotate-1",
      image: "/gleary/gl7.jpg",
    },
  ];
    ...
    >
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2
            className={`text-5xl sm:text-6xl lg:text-7xl font-black leading-tight mb-6 text-amber-100 transform transition-all duration-1000 delay-200 ${
              isVisible
        ...
        >
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8 lg:gap-16 pt-20 max-w-7xl mx-auto px-4">
              {services.slice(0, 3).map((service, index) => (
                ...
                >
                  ...
                  {/* Photo */}
                  <div
                    className="relative bg-white p-2 shadow-2xl cursor-pointer w-[260px] sm:w-[280px] max-w-[90vw]"
                    style={{
                      filter:
                        hoveredPhoto === service.id
                  ...
                  >
                    {/* Photo Area */}
                    <div className="h-60 mb-2 rounded-sm relative overflow-hidden">
                      <ImageWithFallback
                        src={service.image}
                        alt={service.title}
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8 lg:gap-16 pt-20 max-w-7xl mx-auto px-4">
              {services.slice(3, 6).map((service, index) => (
                ...
                >
                  ...
                  >
                    <div className="h-60 mb-6 rounded-sm relative">
                      <ImageWithFallback
                        src={service.image}
                        alt={service.title}
                        className="w-full h-full object-cover rounded-sm"
          ...
          <div className="mt-16 text-center">
            <p className="text-sm text-amber-200/70 leading-relaxed max-w-2xl mx-auto">
              Experience modern conveniences at Concept Capital The Core Mall
